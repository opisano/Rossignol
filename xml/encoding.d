...
public:
    static this()
    {
        ...
        s_encodingTable["ISO-8859-10"] = new Iso8859_10Handler;
        s_encodingTable["ISO-8859-11"] = new Iso8859_11Handler;
        s_encodingTable["ISO-8859-13"] = new Iso8859_13Handler;
        s_encodingTable["ISO-8859-14"] = new Iso8859_14Handler;
        s_encodingTable["ISO-8859-15"] = new Iso8859_15Handler;
        s_encodingTable["ISO-8859-16"] = new Iso8859_16Handler;
    }
...
{
protected:
    // chars > 127 (will be filled in subclasses)
    string[128] m_table;
...
final class Iso8859_9Handler : IsoHandler
{
public:
    this()
    {
...
final class Iso8859_10Handler : IsoHandler
{
public:
    this()
    {
...
final class Iso8859_11Handler : IsoHandler
{
public:
    this()
    {
...
final class Iso8859_13Handler : IsoHandler
{
public:
    this()
    {
...
final class Iso8859_14Handler : IsoHandler
{
public:
    this()
    {
...
final class Iso8859_16Handler : IsoHandler
{
public:
    this()
    {
